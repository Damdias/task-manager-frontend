# task-list-view Specification

## Purpose

TBD - defines the `TaskListPage` list-rendering behavior: loading, error, and empty states, plus basic rendering of fetched tasks. Full card-style presentation is out of scope and delivered by a later change.
